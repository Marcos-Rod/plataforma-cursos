    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="text-white">
                ...
                <p class="mb-2"><i class="fas fa-"></i> Categor&iacute;a: {{$course->category->name}}</p>
                    ...
                    <article class="flex mb-6">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="flex items-center mb-2">
                                <img src="{{$similar->teacher->profile_photo_url}}" alt="" class="h-8 w-8 object-cover rounded-full shadow-lg">
